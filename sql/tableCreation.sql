...
CREATE TABLE grb_uniform_order (
    ...
    CONSTRAINT grb_uniform_order_ibfk_3 FOREIGN KEY (PANTS_STYLE) REFERENCES grb_pants_styles (STYLE_ID),
    CONSTRAINT grb_uniform_order_ibfk_4 FOREIGN KEY (PANTS_SIZE) REFERENCES grb_pants_sizes (SIZE_ID),
    CONSTRAINT grb_uniform_order_ibfk_5 FOREIGN KEY (JERSEY_SIZE) REFERENCES grb_jersey_sizes (SIZE_ID),
    CONSTRAINT grb_uniform_order_ibfk_6 FOREIGN KEY (HAT_SIZE) REFERENCES grb_hat_sizes (SIZE_ID),
    CONSTRAINT grb_uniform_order_ibfk_7 FOREIGN KEY (SHOE_SIZE) REFERENCES grb_shoe_sizes (SIZE_ID),
    CONSTRAINT grb_uniform_order_ibfk_8 FOREIGN KEY (TSHIRT_SIZE) REFERENCES grb_tshirt_sizes (SIZE_ID),
    CONSTRAINT grb_uniform_order_ibfk_9 FOREIGN KEY (SHORTS_SIZE) REFERENCES grb_shorts_sizes (SIZE_ID),
    CONSTRAINT grb_uniform_order_ibfk_10 FOREIGN KEY (SEASON) REFERENCES grb_seasons (SEASON_ID)
);
